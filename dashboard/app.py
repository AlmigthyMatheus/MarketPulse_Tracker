...
st.sidebar.subheader("Support My Work ❤️")
st.sidebar.markdown("[Support on Ko-fi](https://ko-fi.com/c/bf1140c7d8)")
st.sidebar.info("If you enjoy this dashboard, please consider supporting me on Ko-fi!")
